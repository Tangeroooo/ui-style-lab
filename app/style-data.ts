...
export const aestheticRules: Record<string, AestheticRule> = {
  minimal: {
    ...
    allowed: {
      ...
      palette: ["cobalt", "mono", "pureWhite", "enterpriseNavy", "noir", "forest", "aurora", "aqua", "bentoPastel", "nordic", "materialDynamic", "fluent"],
      motion: ["quiet", "subtle"],
    },
  },
  swiss: {
  ...
  material3: {
    ...
    allowed: {
      ...
      fontMode: ["split", "koUnified"],
      palette: ["materialDynamic", "pureWhite", "enterpriseNavy", "cobalt", "candy", "forest", "aqua"],
      motion: ["subtle", "kinetic"],
    },
  },
  material3Dark: {
  ...
  fluent2: {
    ...
    allowed: {
      ...
      fontMode: ["split", "koUnified"],
      palette: ["fluent", "pureWhite", "enterpriseNavy", "cobalt", "mono"],
      motion: ["quiet", "subtle"],
    },
  },
  fluent2Dark: {
  ...
  carbon: {
    ...
    allowed: {
      ...
      fontMode: ["split", "koUnified"],
      palette: ["carbon", "pureWhite", "enterpriseNavy", "mono"],
      motion: ["quiet", "subtle"],
    },
  },
  carbonDark: {
  ...
  shadcn: {
    ...
    allowed: {
      ...
      fontMode: ["split", "koUnified"],
      palette: ["pureWhite", "enterpriseNavy", "mono"],
      motion: ["quiet", "subtle"],
    },
  },
  shadcnDark: {
