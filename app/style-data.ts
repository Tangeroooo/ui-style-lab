...
export const axes: Record<AxisKey, Option[]> = {
  aesthetic: [
    ...
    { id: "appleLiquid", ko: "애플 리퀴드 글래스", en: "Apple Liquid Glass", note: "콘텐츠 위에 떠 있는 adaptive glass control과 concentric geometry" },
    { id: "appleLiquidDark", ko: "애플 리퀴드 글래스 · 다크", en: "Apple Liquid Glass · Dark", note: "dark appearance에 적응하는 base·elevated glass hierarchy" },
  ...
  palette: [
    ...
    { id: "appleSystem", ko: "애플 시스템", en: "Apple System", note: "content-infused glass와 adaptive system blue" },
    { id: "appleSystemDark", ko: "애플 시스템 다크", en: "Apple System Dark", note: "base·elevated dark surface와 vibrant system color" },
...
export const aestheticRules: Record<string, AestheticRule> = {
  ...
  appleLiquid: {
    defaults: { surface: "liquid", layout: "landing", nav: "top", navStyle: "icon", type: "grotesk", koType: "pretendard", fontMode: "split", palette: "appleSystem", motion: "subtle" },
    allowed: {
      surface: ["liquid"],
      layout: ["landing", "cards", "split", "masterDetail"],
      nav: ["top", "left"],
      navStyle: ["icon", "both"],
      type: ["grotesk", "humanist", "rounded"],
      koType: ["pretendard", "suit", "noto"],
      fontMode: ["split", "koUnified"],
      palette: ["appleSystem"],
      motion: ["subtle"],
    },
  ...
  appleLiquidDark: {
    defaults: { surface: "liquid", layout: "landing", nav: "top", navStyle: "icon", type: "grotesk", koType: "pretendard", fontMode: "split", palette: "appleSystemDark", motion: "subtle" },
    allowed: {
      surface: ["liquid"],
      layout: ["landing", "cards", "split", "masterDetail"],
      nav: ["top", "left"],
  ...
  fiori: {
    ...
    allowed: {
      surface: ["flat", "material"],
      layout: ["cards", "dashboard", "masterDetail"],
      nav: ["top"],
      navStyle: ["icon", "both"],
      type: ["grotesk", "humanist"],
      koType: ["plex", "pretendard", "suit", "noto", "spoqa"],
  ...
  zag: {
    ...
    allowed: {
      surface: ["flat", "material"],
      layout: ["landing", "cards", "dense", "dashboard"],
      nav: ["top", "left"],
      navStyle: ["text", "both"],
      type: ["grotesk", "mono"],
  ...
  tamagui: {
    ...
    allowed: {
      ...
      layout: ["landing", "bento", "cards", "dense"],
      nav: ["top", "left"],
      navStyle: ["text", "icon", "both"],
...
export const presets: Preset[] = [
  ...
  { id: "apple-liquid", name: "Apple Liquid Glass", label: "콘텐츠 위에 떠 있는 adaptive glass control", category: "Design System", selection: { aesthetic: "appleLiquid", surface: "liquid", layout: "landing", nav: "top", navStyle: "icon", type: "grotesk", koType: "pretendard", fontMode: "split", palette: "appleSystem", motion: "subtle" } },
  { id: "apple-liquid-night", name: "Apple Liquid Glass Dark", label: "dark appearance의 base·elevated glass hierarchy", category: "Design System", selection: { aesthetic: "appleLiquidDark", surface: "liquid", layout: "landing", nav: "top", navStyle: "icon", type: "grotesk", koType: "pretendard", fontMode: "split", palette: "appleSystemDark", motion: "subtle" } },
...
const optionNotesEn: Record<AxisKey, Record<string, string>> = {
  aesthetic: {
    ...
    appleLiquid: "Adaptive glass controls floating above edge-to-edge content",
    appleLiquidDark: "Base and elevated glass hierarchy for dark appearance",
  ...
  palette: {
    ...
    appleSystem: "Content-infused glass with adaptive system blue",
    appleSystemDark: "Base and elevated dark surfaces with vibrant system color",
