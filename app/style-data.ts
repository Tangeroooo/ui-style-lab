...
export const aestheticRules: Record<string, AestheticRule> = {
  minimal: {
    ...
    allowed: {
      ...
      palette: ["cobalt", "mono", "noir", "forest", "aurora", "aqua", "bentoPastel", "nordic", "materialDynamic", "fluent"],
      motion: ["quiet", "subtle"],
    },
  },
  swiss: {
    ...
    allowed: {
      ...
      fontMode: ["split", "koUnified"],
      palette: ["mono", "primary", "cobalt", "citrus", "carbon"],
      motion: ["quiet", "subtle"],
    },
  },
  bauhaus: {
  ...
  material3: {
    ...
    allowed: {
      ...
      fontMode: ["split", "koUnified"],
      palette: ["materialDynamic", "cobalt", "candy", "forest", "aqua"],
      motion: ["subtle", "kinetic"],
    },
  },
  fluent2: {
