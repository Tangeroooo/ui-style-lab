...
export const axes: Record<AxisKey, Option[]> = {
  ...
  palette: [
    ...
    { id: "primer", ko: "프라이머 라이트", en: "Primer Light", note: "GitHub canvas, subtle border, green·blue action role" },
...
export const aestheticRules: Record<string, AestheticRule> = {
  minimal: {
    ...
    allowed: {
      surface: ["flat", "glass", "acrylic", "neumo", "material", "eink"],
      layout: ["landing", "bento", "cards", "masonry", "split", "dense", "dashboard", "masterDetail", "feed", "supportingPane", "table", "wizard"],
      nav: ["top", "left"],
      ...
      palette: ["cobalt", "mono", "pureWhite", "enterpriseNavy", "enterpriseEvergreen", "enterpriseBurgundy", "enterpriseGraphite", "noir", "forest", "aurora", "aqua", "bentoPastel", "nordic", "materialDynamic", "fluent"],
  ...
  material3: {
    ...
    allowed: {
      ...
      fontMode: ["split", "koUnified"],
      palette: ["materialDynamic", "pureWhite", "enterpriseNavy", "enterpriseEvergreen", "enterpriseBurgundy", "enterpriseGraphite", "cobalt", "candy", "forest", "aqua"],
      motion: ["subtle", "kinetic", "productive", "staged", "spring"],
    },
  },
  material3Dark: {
...
export const presets: Preset[] = [
  ...
  { id: "adaptive-feed", name: "Adaptive Feed", label: "responsive content stream과 빠른 productive feedback", category: "Layout", selection: { aesthetic: "minimal", surface: "glass", layout: "feed", nav: "top", navStyle: "both", type: "grotesk", koType: "pretendard", fontMode: "split", palette: "aqua", motion: "productive" } },
  ...
  { id: "corporate-clean", name: "Navy Workspace", label: "navy rail과 white canvas의 enterprise UI", category: "System", selection: { aesthetic: "minimal", surface: "material", layout: "landing", nav: "left", navStyle: "text", type: "grotesk", koType: "plex", fontMode: "split", palette: "enterpriseNavy", motion: "quiet" } },
  ...
  { id: "burgundy-workspace", name: "Burgundy Workspace", label: "burgundy rail과 pearl canvas의 따뜻한 service UI", category: "System", selection: { aesthetic: "material3", surface: "material", layout: "cards", nav: "left", navStyle: "text", type: "grotesk", koType: "pretendard", fontMode: "split", palette: "enterpriseBurgundy", motion: "subtle" } },
...
const optionNotesEn: Record<AxisKey, Record<string, string>> = {
  ...
  palette: {
    ...
    primer: "GitHub canvas, subtle borders, and green-blue action roles",
