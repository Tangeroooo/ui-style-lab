...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "UI Language Lab",
    description: "One interface, many design languages. Explore up to 568,544 aesthetically compatible full-page combinations.",
    type: "website",
    url: "https://tangerooo.github.io/ui-style-lab/",
    images: [{ url: "/ui-style-lab/og.png", width: 1731, height: 908, alt: "UI Language Lab — the same component kit in Glass, Brutal, Editorial, and Terminal styles" }],
  },
  twitter: {
